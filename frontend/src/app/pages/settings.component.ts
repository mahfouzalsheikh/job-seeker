...
@Component({
  ...
  template: `
    <section class="page">
      ...
      <section class="panel">
        <div class="panel-head"><div><h2>Workspace runtime</h2><p>Core services powering Forth.</p></div><span class="status-chip good">● Runtime configured</span></div>
        ...
        <div class="action-row"><a class="btn-primary" href="/forth-user-guide.html" target="_blank" rel="noopener">Open user guide ↗</a></div>
      </section>
    </section>
  `,
})
